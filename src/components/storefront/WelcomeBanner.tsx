      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-5 items-start sm:items-center">
          ...
          <div className="flex-shrink-0 sm:w-[280px]">
            <span className="inline-flex items-center gap-1.5 text-[10px] sm:text-[11px] font-extrabold tracking-[1.4px] sm:tracking-[1.8px] text-burgundy-dark mb-1.5 sm:mb-2">
              <span
            ...
            <div className="flex gap-3 pb-1 pr-5 sm:pr-8">
              {topProducts.map((product, i) => (
                <button
                  ...
                  className="relative flex-shrink-0 w-[120px] sm:w-[140px] bg-white rounded-xl p-1.5 sm:p-2 text-left cursor-pointer hover:shadow-lg hover:-translate-y-0.5 transition-all border border-line shadow-[0_2px_8px_rgba(0,0,0,0.06)]"
                >
                  {/* Rank badge */}
                  <div
