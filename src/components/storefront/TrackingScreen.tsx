...
export function TrackingScreen({ orderId, customerName, deliveryTimeMin, onClose }: Props) {
  ...
  const eta = new Date();
  eta.setMinutes(eta.getMinutes() + deliveryTimeMin);
    ...
    <div className="fixed inset-0 z-[120] bg-bone flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-8">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 mx-auto bg-sage rounded-full flex items-center justify-center mb-4 animate-[bump_0.5s_ease-out]">
                  ...
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-sm transition-all ${
                      isDone
                        ? "bg-sage text-white"
                        : isActive
                          ? "bg-gold text-sage-dark animate-[glow-pulse_2s_ease-in-out_infinite]"
