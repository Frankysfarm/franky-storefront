            ...
            {items.map((product, i) => {
              ...
              return (
                <button
                  ...
                  className="relative flex-shrink-0 w-[110px] sm:w-[140px] bg-white rounded-xl overflow-hidden cursor-pointer hover:shadow-lg hover:-translate-y-0.5 transition-all border border-line shadow-[0_2px_8px_rgba(0,0,0,0.06)] text-left"
                >
                  {/* Rank badge */}
                  <div
